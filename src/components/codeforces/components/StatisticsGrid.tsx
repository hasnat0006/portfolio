...
function StatCard({
  ...
  const displayValue = isText ? String(value) : typeof value === "number" ? animated : value;
  ...
  return (
    <div
      ...
      style={{
        ...
        animation: visible ? `cf-stat-in 0.5s ease-out ${delay}ms both` : "none",
...
export function StatisticsGrid({ userInfo, stats }: Props) {
  ...
  const cards: StatCardProps[] = [
    ...
    },
    {
      ...
      color: stats.acceptanceRate >= 50 ? "var(--text-accent)" : "var(--text-error)",
      visible,
      delay: 250,
    },
    {
    ...
    },
    {
      ...
      color: stats.hardestSolved?.rating ? getRankColor(
        stats.hardestSolved.rating >= 2600 ? "grandmaster"
        : stats.hardestSolved.rating >= 2300 ? "master"
        : stats.hardestSolved.rating >= 1900 ? "expert"
        : stats.hardestSolved.rating >= 1600 ? "specialist"
        : "pupil"
      ) : undefined,
      visible,
      delay: 450,
